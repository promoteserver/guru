...
<?php include "navbar.php" ?>
	...
	<div class="col-lg-12">
		...
		<div class="mainheader">      <a class="link" href="blog.php">OUR BLOG </a> <span><img src="images/arrow1.png" width="15" height="15"><a  class="link" href="#">ARTIST PAINTS</a><img src="images/arrow2.png" width="15" height="15"></span><a class="link" href="artist_tattoos.php?userid=<?php echo $CurrentUserId;?>">ARTIST TATTO'S</a>
</div>
   ...
   <h1><?php echo $user['name']; ?></h1> <a href="artist_tattoos.php?userid=<?php echo $CurrentUserId ?>"><h4 >View Tattoo's Gallery</h4></a>
...
$sql2=mysql_query("SELECT * from users_paints where user_id='$CurrentUserId'");
while($userimg=mysql_fetch_array($sql2))
{

echo '

<a class="rsImg"  href="images/gallery-paints/'.$userimg['photo'].'" style="margin-left:0;"> <img class="rsTmb" src="images/gallery-paints/thumb/'.$userimg['photo'].'" /></a>
