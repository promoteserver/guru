		  ...
		  if(isset($_POST['title']) and isset($_POST['introduction']) and isset($_POST['content']))
		   {
			  ...
			  mysql_query("INSERT INTO posts (id,title,introduction,content,user_id,created,modified) VALUES(NULL,'$title','$introduction','$content','$user_id','$currentDate','$currentDate')") or exit(mysql_error());
