...
$sql=mysql_query("SELECT DISTINCT e.id as event_id,eg.id as egId ,eg.photo as egphoto,e.title as title,e.introduction as introduction,e.start as start,e.modified as M from events as e left join events_gallery as eg on eg.event_id=e.id where e.start <= CURDATE() GROUP BY e.id order by M desc LIMIT 0,5");
$query=mysql_query("SELECT e.id as event_id,eg.id as egId ,eg.photo as egphoto,e.title as title,e.introduction as introduction,e.start as start,e.modified as M from events as e left join events_gallery as eg on eg.event_id=e.id where e.start <= CURDATE()");
      ...
      $(window).scroll(function(){
        ...
        {     
          ...
          if(load*5 > count)
          {
            ...
            $.post("ajax3.php",{load:load},function(data){
            $('.wrap').append(data);
            $('.loader').hide();
...
<section class="main">
  ...
  <div class="col-lg-12">
    ...
    <div class="mainheader">
      <a class="link" href="blog.php">OUR BLOG </a> <span><img src="images/arrow1.png" width="15" height="15"><a  class="link" href="#">RECENT EVENTS</a><img src="images/arrow2.png" width="15" height="15"></span><a class="link" href="event-list.php">EVENTS</a>
    </div>
  </div>
  ...
  if($event['egphoto'] != NULL) // si evet_gallery es distinto de null
  {
        ...
        <div class="event-intro col-lg-6">          
          ...
          <br><br>
                     ...
                     <a href="event.php?id='.$event['event_id'].'" class="link" >MORE <img src="images/view.png" width="10" height="15" style="margin-top:-5px; margin-left:10px"></a>
...
';
  ...
  <br> ';
    ...
    echo'<a class="link" href="event.php?id='.$event['event_id'].'">MORE <img src="images/view.png" width="10" height="15" style="margin-top:-5px;"></a> 
