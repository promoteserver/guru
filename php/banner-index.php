 <?php 
  ...
  echo '<a href="post.php?id='.$postId.'"><img src="http://gurutattoo.net/images/gallery-post/'.$banner['photo'].'"  alt="'.$banner['desc_es'].'"class="imghome"></a>';
  ...
  ?>
    ...
    <div class="banner_index_content">
           ...
           <?php        
            ...
            echo '<a href="post.php?id='.$postId.'"><span class="viewmore center-block">MORE <img src="http://gurutattoo.net/images/view.png" align="middle" height="15" width="10"></span></a>';         
