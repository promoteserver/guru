...
if(isset($_GET['albid']) and !empty($_GET['albid'] )){
	$albidId = intval($_GET['albid']);
	$sql1 = mysql_query("SELECT * FROM users WHERE id='$albidId'");
...
<div id="interface">
  <div class="dashBoard-admin">
  	<h1><?php echo $row2['username'] ?>  Tattoos</h1>
			 ...
			 if($cnt > 0){
				 while($row = mysql_fetch_array($sql)){
					 echo '<div class="thumb-case">
					       <img src="../thumbnail.php?src=/images/gallery/zoom/'.$row['photo'].'&h=60&w=60&q=500" class="thubm_view" />
