...
?>
<center>
<span style="font-family:Lucida Sans Unicode, Lucida Grande, sans-serif;color: #414141;font-size: 11px;">
      ...
      <input type="hidden" name="id" value="<?php echo $_GET['id']; ?>" />
		...
		if (mysql_num_rows($result1) != 0)
		{
          ...
          <tr>
            <td align="left"><br /></td>
            <td align="left"><input type="submit" name="guardar" onclick="return enviar();" value=" " style="border:#FFF 0px solid;background-image:url(guardar.png); width:104px; height:27px;" />&nbsp;&nbsp;<input type="button" value=" " style="border:#FFF 0px solid;background-image:url(cancelar.png); width:112px; height:27px;" onclick="window.location='lista-tips.php'" /></td>
            <td align="left">&nbsp;</td>
          </tr>
          <tr>
