<?php
      class Gallery {
		  ...
		  public function picToRemove($picId){
		    ...
		    public function picToRemovePaint($picId){
		    ...
		    public function picToRemoveEvent($picId){
			  $sql = mysql_query("SELECT * FROM  events_gallery WHERE id='$picId'");
			  $this->picNumber = mysql_num_rows($sql);
			  if($this->picNumber > 0){
				  $row = mysql_fetch_array($sql);
				  return $row['photo'];
		    ...
		    public function picToRemovePost($picId){
			  $sql = mysql_query("SELECT * FROM  posts_gallery WHERE id='$picId'");
			  $this->picNumber = mysql_num_rows($sql);
			  if($this->picNumber > 0){
				  $row = mysql_fetch_array($sql);
				  return $row['photo'];
